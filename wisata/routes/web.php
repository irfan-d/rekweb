...
$router->group(['prefix' => 'api'], function () use ($router) {
    ...
    $router->get('hotel', ['uses' => 'HotelController@showAll']);
    $router->get('hotel/{id}', ['uses' => 'HotelController@showOne']);
    $router->post('hotel', ['uses' => 'HotelController@create']);
    $router->delete('hotel/{id}', ['uses' => 'HotelController@delete']);
    $router->put('hotel/{id}', ['uses' => 'HotelController@update']);
